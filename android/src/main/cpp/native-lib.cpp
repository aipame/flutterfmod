...
Channel *channel;
//com.example.flutterfmod
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_flutterfmod_FmodSound_saveSound(JNIEnv *env, jobject cls, jstring path_jstr, jint type, jstring save_jstr) {
    Sound *sound;
    DSP *dsp;
    bool playing = true;
    float frequency = 0;
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_flutterfmod_FmodSound_playSound(JNIEnv *env, jobject cls, jstring path_jstr, jint type) {
    Sound *sound;
    DSP *dsp;
    bool playing = true;
    float frequency = 0;
...
Java_com_example_flutterfmod_FmodSound_stopPlay(JNIEnv *env, jobject jcls) {
    LOGI("%s", "stopPlay")
    channel->stop();
}

extern "C" JNIEXPORT void JNICALL
Java_com_example_flutterfmod_FmodSound_resumePlay(JNIEnv *env, jobject jcls) {
    LOGI("%s", "resumePlay")
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_flutterfmod_FmodSound_pausePlay(JNIEnv *env, jobject jcls) {
    LOGI("%s", "pausePlay")
    channel->setPaused(true);
}

extern "C" JNIEXPORT jboolean JNICALL
Java_com_example_flutterfmod_FmodSound_isPlaying(JNIEnv *env, jobject jcls) {
    LOGI("%s", "isPlaying")
    bool isPlaying = true;
